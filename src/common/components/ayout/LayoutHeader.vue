  ...
  >
    ...
    <div class="flex flex-grow px-3 w-auto h-full">
      <div class="text-gray-900 w-full mr-2 md:max-w-94.4 text-md dark:text-light-100 rounded-sm flex items-center border-r-1 border-dark-100/5 dark:border-light-100/5">
        ...
        <a-tree-select
          v-model:value="selectedClient" :loading="!treeDataClients"
          :size="mdAndLarger ? 'middle' : 'middle'" show-search class="w-full min-w-45 mr-2" tree-node-filter-prop="title"
          ...
          :disabled="!treeDataClients" :tree-data="treeDataClients || []" :height="255" virtual
          dropdown-class-name="!mx-auto"
